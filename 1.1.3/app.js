...
window.onload = function(){
	...
	core.preload('./img/hori1.png','./img/background1.png','./img/window1.png','./img/bluedragon.png','./img/monster2.gif','./img/monster3.gif','./img/gameover.png','./img/start.jpg','./img/sword1.png','./img/box.png','./img/swordicon.jpg','./img/boss1.png','./img/sickle.png','./img/effect1.png',);
	core.fps = 20;
	core.onload = function(){
		...
		var createHomeScene = function(){
			...
			background.image = core.assets['./img/start.jpg'];
			background.x = 270;
			background.y = 400;
			background.scaleX = 5;
			background.scaleY = 5;
		...
		var createGameScene = function(){
			...
			hori.image = core.assets['./img/hori1.png'];
			hori.x = 80;
			hori.y = GROUND_LINE;
			hori.scaleX = 1.3;
			hori.scaleY = 1.3;
			...
			//horihit.image = core.assets['./img/start.jpg'];
			horihit.x = hori.x ;
			horihit.y = hori.y ;
			...
			//boxhit.image = core.assets['./img/start.jpg'];
			boxhit.x = 1750;
			boxhit.y = 295;
			
			
			var sword1 = new Sprite(393,395);
			sword1.image = core.assets['./img/sword1.png'];
			sword1.scaleX =  0.35;
			sword1.scaleY = 0.35;
			sword1.rotate(225);
			
			var sword1hit = new Sprite(200,15);
			//sword1hit.image = core.assets['./img/start.jpg'];
			sword1hit.x = 590;
			
			
			
			var swordicon = new Sprite(300,300);
			swordicon.image = core.assets['./img/swordicon.jpg'];
			swordicon.x = 170;
			swordicon.y = 750;
			...
			bluedragon.image = core.assets['./img/bluedragon.png'];
			bluedragon.frame = 4;
			bluedragon.scaleX = 2;
			bluedragon.scaleY = 2;
			bluedragon.x = 1800;
			...
			//bluedragonhit.image = core.assets['./img/start.jpg'];
			bluedragonhit.x = 1787;
			bluedragonhit.y = 300;
			
			var bluedragonhit2 = new Sprite (64,64);
			//bluedragonhit2.image = core.assets['./img/start.jpg'];
			bluedragonhit2.x = 1855;
			bluedragonhit2.y = 300;
		
			
			var bat = new Sprite (48,37);
			bat.image = core.assets['./img/monster3.gif'];
			bat.frame = 2;
			bat.scaleX = 3;
			bat.scaleY = 3;
			bat.x = 1000;
			...
			//bathit.image = core.assets['./img/start.jpg'];
			bathit.x = 985;
			bathit.y = 485;
			
			
			var monster2 = new Sprite (64,68);
			monster2.image = core.assets['./img/monster2.gif'];
			monster2.frame = 2;
			monster2.scaleX = 3;
			monster2.scaleY = 3;
			monster2.x = 900;
			...
			//monster2hit.image = core.assets['./img/start.jpg'];
			monster2hit.x = 852;
			monster2hit.y = GROUND_LINE;
			
			var monster2hit2 = new Sprite (78,78);
			//monster2hit2.image = core.assets['./img/start.jpg'];
			monster2hit2.x = 930;
			monster2hit2.y = GROUND_LINE;
			
			
			var boss1 = new Sprite(320,260);
			boss1.image = core.assets['./img/boss1.png'];
			boss1.opacity = 0.0;
			boss1.scaleX = 1.5;
			boss1.scaleY =  1.5;
			boss1.x = 300;
			...
			sickle.image = core.assets['./img/sickle.png'];
			sickle.opacity = 0.0;
			sickle.x = 130;
			sickle.y = -20;
			sickle.scaleX = 0.5;
			...
			magic.image = core.assets['./img/effect1.png'];
			magic.x = 30;
			magic.y = 570;
			
			var magichit = new Sprite (120,120);
			//magichit.image = core.assets['./img/start.jpg'];
			magichit.x = 70;
			magichit.y = 620;
			
			var magic1 = new Sprite(190,190);
			magic1.image = core.assets['./img/effect1.png'];
			magic1.x = 180;
			magic1.y = 200;
			
			var magic2 = new Sprite(190,190);
			magic2.image = core.assets['./img/effect1.png'];
			magic2.x = 500;
			magic2.y = 170;
			
			var magic3= new Sprite(190,190);
			magic3.image = core.assets['./img/effect1.png'];
			magic3.x = 540;
			magic3.y = 570;
			
			var magic4= new Sprite(190,190);
			magic4.image = core.assets['./img/effect1.png'];
			magic4.x = 360;
			magic4.y = 370;
			...
			bg1.image = core.assets['./img/background1.png'];
			bg1.x = 245;
			bg1.y = 450;
			bg1.scaleX = 6;
			bg1.scaleY = 8;
			...
			bg2.image = core.assets['./img/background1.png'];
			bg2.frame = 1;
			bg2.x = 833;
			bg2.y = 450;
			bg2.scaleX = 6;
			...
			bg3.image = core.assets['./img/background1.png'];
			bg3.frame = 2;
			bg3.x = 1410;
			bg3.y = 450;
			bg3.scaleX = 6;
			...
			bg4.image = core.assets['./img/background1.png'];
			bg4.frame = 3;
			bg4.x = 1998;
			bg4.y = 450;
			bg4.scaleX = 6;
		...
		createGameoverScene = function(scroll){
			...
			gameoverImage.image = core.assets['./img/gameover.png'];
			gameoverImage.x = 250;
			gameoverImage.y = 250;
